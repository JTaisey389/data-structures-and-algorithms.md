...
const allUpperCase = (arr) => { // we are constraining the letters to alluppercase to the array
  // solution goes here 
  const result = []; // nexr we constrain and pass the results into the empy array
  // work goes here
