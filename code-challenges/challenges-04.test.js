...
// const containsW = (str) => {
//   const regexToTest = /w/gm;
//   const outPutOfText = regexToTest.test(str); //will be true or false
//   return outPutOfTest 
//   // this if statement is duplicative 
//   if(outPutOfText){
//     return true;
//   } else {
//     return false;
...
const isNum = (input) => {
  // Solution code here...
  const testToTruth = /\d/;
  const outPutOfTruth = testToTruth.test(input);

  return outPutOfTruth;
};
...
const containsWorld = (input) => {
  // Solution code here...
  const testConsWorld = /world\b/;
  const checkOutput = testConsWorld.test(input);
...
const isCapitalized = (str) => {
  // Solution code here...
  const testIsCap = /\b[A-Z][a-z]+\b/gm;
  return str.match(testIsCap)|| [];
};
